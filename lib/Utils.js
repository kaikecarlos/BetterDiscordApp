...
Utils.prototype.jsLog = function(message, type) {
    ...
    switch(type) {
        case "log":
            this.execJs('console.log("KaikoDiscord: ' + message + '");');
            break;
        case "warn":
            this.execJs('console.warn("KaikoDiscord: ' + message + '");');
            break;
        case "error":
            this.execJs('console.error("KaikoDiscord: ' + message + '");');
            break;
    }
}
...
Utils.prototype.log = function(message) {
    console.log("[KaikoDiscord INF] " + message);
    var d = new Date();
...
Utils.prototype.err = function(err) {
    console.log("[KaikoDiscord ERR] " + err.message);
    var d = new Date();
    var ds = ("00" + (d.getDate() + 1)).slice(-2) + "/" + 
    ("00" + d.getMonth()).slice(-2) + "/" + 
    d.getFullYear() + " " + 
...
Utils.prototype.warn = function(message) {
    console.log("[KaikoDiscord WRN] " + message);
    var d = new Date();
    var ds = ("00" + (d.getDate() + 1)).slice(-2) + "/" + 
    ("00" + d.getMonth()).slice(-2) + "/" + 
    d.getFullYear() + " " + 
